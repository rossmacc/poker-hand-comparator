  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>dashboard" class="logo">
      ...
      <span class="logo-lg"><b>Poker</b>Hand</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                      <?php echo 'Hi '. $auth_username.' your ID is '.$auth_user_id ?>
                      <small><?php echo  $auth_email ?></small>
                      <small><?php echo 'Group: '. $auth_role ?></small>
                    </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
